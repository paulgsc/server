...
ALTER TABLE browser_tabs ADD COLUMN new_pinned BOOLEAN;
ALTER TABLE browser_tabs ADD COLUMN new_highlighted BOOLEAN;
ALTER TABLE browser_tabs ADD column new_active BOOLEAN;
ALTER TABLE browser_tabs ADD column new_incognito BOOLEAN;
ALTER TABLE browser_tabs ADD column new_selected BOOLEAN;
ALTER TABLE browser_tabs ADD column new_audible BOOLEAN;
ALTER TABLE browser_tabs ADD column new_discarded BOOLEAN;
ALTER TABLE browser_tabs ADD column new_auto_discardable BOOLEAN;
